   ...
   <head>
    <meta charset="UTF-8">
     <!--
	    ...
	    October 15, 2016
	    Project 3 
              - Continue improving game by adding text box and additional locations.
      -->

      <!-- Browser Tab Title -->
  /*    <title> Murphy's World </title>

      <!-- set up standard styles for output.  
              Makes it easier to change styles for output to user -->
         ...
         <style  type ="text/css">
          ...
          <h1> Welcome to Murphy's World! </h1>
